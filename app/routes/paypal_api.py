...
def _is_guest_user(user_id: str) -> bool:
    ...
    # Compat con variantes
    return u == "guest" or u.startswith("guest-") or u == "id-guest" or u.startswith("id-guest-")
...
def paypal_create_order():
    ...
    if _is_guest_user(user_id):
        # ✅ Bloqueo en backend para evitar créditos perdidos
            ...
            "purchase_units": [
                {
                    ...
                    # custom_id ayuda a trazabilidad; no es seguridad, pero sirve
                    "custom_id": user_id,
                }
            ],
        }
...
def paypal_capture_order():
    ...
    try:
        ...
        # ✅ Solo guardamos "captured" si es COMPLETED
        if status != "COMPLETED":
        ...
        # ✅ Determinar plan por precio (truth del server)
